...
class _MessagesPageState extends State<MessagesPage> {
  List<Message> messages = [
    Message(message: 'hi', dateTime: DateTime.now().subtract(const Duration(minutes: 1)),a: false ),
    Message(message: 'hi', dateTime: DateTime.now().subtract(const Duration(minutes: 1)), a: true),
  ].reversed.toList();
